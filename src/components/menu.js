...
function menu() {
  ...
  content.append(
    createMenuElement(ramen, "Shoyu Ramen"),
    createMenuElement(ramen, "Vegetarian Ramen"),
    createMenuElement(sushi, "Sushi Assortment"),
    createMenuElement(omurice, "Omurice"),
    createMenuElement(desert, "Mango Pudding"),
    createMenuElement(desert, "Passionfruit Pudding")
  );
  return content;
}
