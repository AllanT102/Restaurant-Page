...
function reviewsSection() {
  ...
  const r1 =
    '"Great service, food, atmosphere and prices make this a special place."';
...
function reveal() {
  ...
  for (let i = 0; i < children.length; i++) {
    ...
    if (height > windowHeight + 200 || height < 200)
      child.classList.contains("left")
        ? child.classList.remove("active-left")
        : child.classList.remove("active-right");
    else if (height > 0 && height < windowHeight && i % 2 === 0)
      child.classList.add("active-right");
    else if (height > 0 && height < windowHeight && i % 2 !== 0)
      child.classList.add("active-left");
  }
}
...
function menu() {
  ...
  content.append(
    createMenuElement(_src_images_ramen_png__WEBPACK_IMPORTED_MODULE_2__, "Shoyu Ramen"),
    createMenuElement(_src_images_ramen_png__WEBPACK_IMPORTED_MODULE_2__, "Vegetarian Ramen"),
    createMenuElement(_src_images_sushi_png__WEBPACK_IMPORTED_MODULE_3__, "Sushi Assortment"),
    createMenuElement(_src_images_omurice_png__WEBPACK_IMPORTED_MODULE_1__, "Omurice"),
    createMenuElement(_src_images_desert_png__WEBPACK_IMPORTED_MODULE_4__, "Mango Pudding"),
    createMenuElement(_src_images_desert_png__WEBPACK_IMPORTED_MODULE_4__, "Passionfruit Pudding")
  );
  return content;
}
